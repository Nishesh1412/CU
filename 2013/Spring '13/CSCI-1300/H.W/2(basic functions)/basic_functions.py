...
# basic_functions.py
#
# Your Name: Nishesh Shukla
# Your TA:
# Your List of Colaborators:Dominic Pontious
#
...
def get_primes_below(num):
    """
    Given an input number 'num', create a list that contains all the
    prime numbers that are smaller than it. Do not include 1 or the
    number itself in the output.
